...
let isPlaying = false;
const originalPlaylist = JSON.parse(localStorage.getItem("playlist")) ?? [music1, music2, music3,music4, music5, music6, music7, music8, music9];
let index = 3;
...
function updateProgress(){
    ...
    currentProgress.style.setProperty("--progress",`${barWidth}%`);songTime.innerText = toHHMMSS(song.currentTime);
}
